...
icon: "book-open"
description: "OuterProduct is a Python SDK and hosted API for AI reasoning on structured data."
---

OuterProduct gives you a small, typed Python surface for AI reasoning on structured data, training models, generating predictions, and producing feature-level reasoning on our infrastructure. 
