...
description: "Connect the OuterProduct MCP server to Claude, Cursor, or any MCP client and train models, explain predictions, and run counterfactuals in plain English."
---

The OuterProduct MCP server bridges your favourite LLM interface and the OuterProduct platform. Once you add a single URL, the assistant can train tabular ML models, generate predictions, produce per-feature explanations, run counterfactuals, and mine decision-pattern aggregates — all without leaving your chat window.
...
<CardGroup cols={2}>
  <Card title="Training" icon="brain">
    Fit a model on any tabular dataset you upload or reference.
  </Card>
