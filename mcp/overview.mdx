...
OuterProduct ships pre-built workflows for common real-world use cases. When your prompt matches a recognised scenario, the assistant follows the workflow automatically.
