...
description: "Bolt traceable reasoning onto your risk-scoring model for audit trails, policy optimization, and per-applicant counterfactuals — production untouched."
---
