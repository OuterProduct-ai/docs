...
<Steps>
  ...
  <Step title="Run inference with native reasoning">
    Reasoning models come with additional reasoning functions.  For example, get predictions with real-time attributions. (See Overview for additional examples of reasoning like running scenarios.)
