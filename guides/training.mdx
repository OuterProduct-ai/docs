...
icon: "dumbbell"
description: "Train models on structured data using op.reasoning.fit() for a ReasoningModel or Trainer.configure().run() for a plain Model, with full HPO and metric control."
---
