...
Scenarios address a concrete question: _"What is the smallest change to this input that would flip the model's prediction?"_ Instead of just knowing that a loan application was denied, you can tell the applicant exactly what would need to change (credit score up by 40 points, adding a co-borrower with certain attributes) to receive a different outcome. Our scenario endpoint derives an exhaustive list of minimal counterfactuals.
