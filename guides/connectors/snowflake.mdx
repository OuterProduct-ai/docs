...
icon: "snowflake"
description: "Authenticate your OuterProduct account with your Snowflake account via Workload Identity Federation."
---

## Give your OuterProduct account permission to access your Snowflake Account

We authenticate with Snowflake via OIDC based [Workload Identity Federation](https://docs.snowflake.com/en/user-guide/workload-identity-federation).
...
ws.register_snowflake("customers", "MYDB.PUBLIC.CUSTOMERS", connector_name="prod-snowflake")
