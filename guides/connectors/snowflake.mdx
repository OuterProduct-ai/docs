...
## Give your OuterProduct account permission to access your Snowflake aaccount

We authenticate with Snowflake via [Workload Identity Federation](https://docs.snowflake.com/en/user-guide/workload-identity-federation), an OAuth-token-based authentication flow[Workload Identity Federation](https://docs.snowflake.com/en/user-guide/workload-identity-federation), an OAuth-token-based authentication flow.
