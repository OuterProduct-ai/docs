...
description: "Stage local tabular data with outerproduct.LocalDataset (CSV, Parquet, pandas, NumPy) and upload it to a server-backed Dataset for training and inference."
---
