...
description: "API reference for op.reasoning.fit() and PatternTracker: train reasoning models and distil population-level patterns from their predictions."
---
...
<ParamField body="n_hyperopt_steps" default="5" type="int">
...
# task (and label_column) is optional when a teacher is provided
model = op.reasoning.fit(
    train,
    teacher=teacher,
).wait()
